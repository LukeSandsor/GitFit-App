            ...
            <div className='center'>
                ...
                <label style={{ textAlign: 'center' }}>
                    <text style={{ color: 'white', fontSize: 18 }}>
                        <h1>Privacy Policy of GitFit</h1>
                        <p>GitFit operates the www.gitfit.me website, which provides the personalized fitness-tracking service.</p>
                        <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the GitFit website.</p>
                        <p>If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy. Our Privacy Policy was created with the help of a Privacy Policy Generator.</p>
